...
export const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  return (
    <div className="soft-surface p-8 border border-black/5">
      <h2 className="text-xl font-bold text-slate-800 mb-6 font-heading tracking-tight">Settings</h2>

      {/* Mode Selection */}
      <div className="mb-8 soft-element p-1.5 flex gap-1 bg-stone-100/50">
        <button
          onClick={() => onModeChange('AI')}
          className={`flex-1 py-2.5 px-3 rounded-lg text-xs font-bold transition-smooth ${generationMode === 'AI'
        ...
        <button
          ...
          className={`flex-1 py-2.5 px-3 rounded-lg text-xs font-bold transition-smooth ${generationMode === 'Algorithm'
            ? 'bg-white text-amber-700 shadow-sm border border-[#E8DEC1]'
            : 'text-stone-500 hover:text-stone-700 hover:bg-stone-200/50'
            }`}
        >
        ...
        <div className="mb-8 border-t border-[#E8DEC1] pt-5">
          ...
          >
            ...
            <div className="p-1.5 bg-stone-50 rounded-md">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className={`w-3.5 h-3.5 transform transition-transform duration-300 ${showAdvanced ? 'rotate-180' : ''}`}>
