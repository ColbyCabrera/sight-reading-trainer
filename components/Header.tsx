    ...
    <header className="bg-white/80 backdrop-blur-md border-b border-black/5 sticky top-0 z-50">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center max-w-7xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-stone-800 font-heading tracking-tight leading-none">Virtuoso</h1>
            <p className="text-[10px] text-stone-500 uppercase tracking-[0.2em] font-bold mt-1">Sight-Reading Trainer</p>
          </div>
        </div>
